...
import EmplodeLogo from "@/components/empode"
  ...
  useEffect(() => {
    ...
    if (isGenerating) {
      ...
      if (dataCollected && !lastMessage.content) {
        setStatusMessage('The Agent has collected data and is generating a response. Please wait.');
      } else {
        setStatusMessage('The Agent is currently processing your request. Please wait.');
      }
        ...
        <div className="fixed top-0 left-0 right-0 z-20">
          <div className="w-full max-w-2xl mx-auto border-x-2 border-b-2 border-[#E5E7EB] bg-white">
            <div className="px-4 py-4 flex justify-between items-center">
              <a href="https://www.emplode.com" target="_blank" rel="noopener noreferrer" className="text-sm font-medium underline">Powered by Emplode</a>
              <h1 className="text-2xl font-bold flex items-center">
                <a href="https://www.emplode.com" target="_blank" rel="noopener noreferrer" className="mr-1">
                  <EmplodeLogo />
                </a>
                <span className="mx-1">/Automode.</span>
          ...
          <div className="flex-grow flex flex-col w-full max-w-xl mx-auto py-4 px-4"> {/* Added px-4 */}
            {!hasInteracted && messages.length === 0 ? (
              <div className="flex-grow flex flex-col justify-start items-center text-center mt-56">
                ...
                <p className="sm:mb-10 mb-8 sm:text-sm text-xs">What task can I perform for you today?</p>
                </BlurFade>
                ...
                <div key={m.id} className="whitespace-pre-wrap">
                  {m.role === 'user' ? (
                    ...
                    <>
                      ...
                      <a href="https://www.emplode.com" target="_blank" rel="noopener noreferrer" >
                    <EmplodeLogo />
                      </a>
